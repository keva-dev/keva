...
import static com.jinyframework.keva.server.protocol.redis.Encoding.NEG_ONE_WITH_CRLF;
import static com.jinyframework.keva.server.protocol.redis.Encoding.numToBytes;
