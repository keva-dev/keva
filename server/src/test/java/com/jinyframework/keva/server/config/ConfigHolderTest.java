...
class ConfigHolderTest {
    ...
    @Test
    void fromPropsDefault() throws Exception {
        val def = makeDefaultConfig();
    ...
    void fromProperties() throws Exception {
        ...
        props.setProperty("snapshot_location", "./");
        ...
        assertEquals("./", configHolder.getSnapshotLocation());
